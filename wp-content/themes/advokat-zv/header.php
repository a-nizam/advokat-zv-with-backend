...
<head>
    ...
    <title>Цены на адвоката по уголовным делам</title>
        ...
        <div class="container">
            <div class="row">
                <div id="logo" class="col-lg-4 col-md-5 col-sm-5 col-xs-12">
                    <a href="/" title="Адвокат" class="logo"><!-- TODO: Вставить ссылку и тайтл -->
                        <h1>Услуги адвоката <br/>физическим лицам</h1>
                    </a>
                </div>
                <div class="col-lg-3 col-lg-offset-3 col-md-3 col-md-offset-2 col-sm-4 col-sm-offset-0 col-xs-12 contacts">
                    г.Махачкала, <br
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Об
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 question">
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="inputName" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">ФИО</label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input class="form-control" id="inputName" placeholder="ФИО" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputCity" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">Город</label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                        ...
                        <div class="form-group">
                            <label for="inputEmail" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">Email</label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <input class="form-control" id="inputEmail" placeholder="Email" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="textAreaQuestion" class="col-lg-2 col-md-2 col-sm-2 col-xs-12 control-label">Вопрос</label>
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
